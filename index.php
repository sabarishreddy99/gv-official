...
<head>
  ...
  <title>Sign Up - gradeVITian</title>
    ...
    <div class="container-fluid">
      ...
      <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
          ...
          <a href="CGPA Calculator.php">CGPA Calculator</a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link"  href="CGPA Calculator.php">CGPA Calculator</a>
          </li>
          <li class="nav-item">
...
<div class="login-signup-btn">
  <p>Already have an account? 
    <button type="button" class="btn btn-dark btn-md" onclick="window.location.href='login.php'" >Log In</button></p>
</div>
...
<h2>Sign Up</h2>
<img class="signup-img" src="img/signup-img.svg" alt="sign up">
...
if(isset($_GET["error"])){
  if($_GET["error"] == "emptyinput"){
    ...
    echo "<P style='color: #DC143C;' >Choose a proper username!</P>";
  }

  else if($_GET["error"] == "invalidemail"){
    echo "<P style='color: #DC143C;' >Choose a proper Email!</P>";
  }

  else if($_GET["error"] == "passwordsdontmatch"){
    echo "<P style='color: #DC143C;' >Passwords doesn't match!</P>";
  }


  else if($_GET["error"] == "stmtfailed"){
    echo "<P style='color: #DC143C;' >Oops! Something went wrong. Please try again.</P>";
  }


  else if($_GET["error"] == "usernametaken"){
    echo "<P style='color: #DC143C;' >Username already taken!</P>";
  }


  else if($_GET["error"] == "none"){
    echo "<P style='color: #228B22;' >Yay! You have signed up successfully.</P>";
  }
...
<button type="submit" name="submit" class="btn btn-dark btn-md" id="">Sign Up</button>
</form>

<br>
<p style="color:gray;">Already an user? <a href="login.php" style="color:#191970;">Log In </a></p>
<p>Signing up signifies that you have read and agree to the  <a href="Terms and Conditions.php">Terms and Conditions <i class="fas fa-external-link-alt"></i></a> and our <a href="Privacy Policy.php">Privacy Policy <i class="fas fa-external-link-alt"></i></a>.</p>
   ...
   <h4>Already have an account? 
    <button type="button" class="btn btn-outline-dark btn-md" style="border-width:3px; " onclick="window.location.href='login.php'">Log In</button></h4>
    <br>
