...
<html lang="en">
  <head>
    ...
    <title>gradeVITian - Terms and Conditions</title>
  ...
  <body class="container">
    ...
    <p>Last updated: 2021-03-23</p>
    <p>1. <b>Introduction</b></p>
    <p>
      Welcome to <b><a href="https://gradevitian.in/">gradeVITian.</a> </b>
      (“Company”, “we”, “our”, “us”)!
    </p>
    <p>
      These Terms of Service (“Terms”, “Terms of Service”) govern your use of
      our website located at <b>gradevitian.in</b> (together or individually
      “Service”) operated by <b>Sabarish Reddy Remala</b>.
    </p>
    <p>
    ...
    <p>
      ...
      <b>sabarirjsr@gmail.com</b> so we can try to find a solution. These Terms
    ...
    <p>
      ...
      <b><a href="mailto:sabarirjsr@gmail.com">sabarirjsr@gmail.com</a> </b>.
    </p>
    ...
    <p>
      gradeVITian has the right but not the obligation to monitor and edit all
      Content provided by users.
    </p>
    <p>
      In addition, Content found on or through this Service are the property of
      gradeVITian or used with permission. You may not distribute, modify,
    ...
    <p>
      ...
      eighteen (13) years old. By accessing or using Service, you warrant and
      ...
      thirteen (13) years old, you are prohibited from both the access and usage
      of Service.
    </p>
    <p>8. <b>Accounts</b></p>
    <p>
    ...
    <p>
      ...
      gradeVITian and its licensors. Service is protected by copyright,
      ...
      written consent of gradeVITian.
    </p>
    ...
    <p>
      ...
      a detailed description of the alleged Infringement as detailed below,
    ...
    <p>
      You can contact our Copyright Agent via email at sabarirjsr@gmail.com.
    </p>
    <p>12. <b>Error Reporting and Feedback</b></p>
    <p>
      You may provide us either directly at sabarirjsr@gmail.com or via third
    ...
    <p>
      ...
      are not owned or controlled by gradeVITian.
    </p>
    <p>
      gradeVITian has no control over, and assumes no responsibility for the
    ...
    <p>
      ...
      India, which governing law applies to agreement without regard to its
    ...
    <div style="text-align: center; color: rgb(19, 168, 168)">
      <b><a href="https://gradevitian.in/">Back to home.</a></b>
    </div>
    <br />
  </body>
</html>
